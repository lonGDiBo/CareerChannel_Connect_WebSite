          ...
          (<>
            ...
            <Box sx={{ flexGrow: 1 }}>
              <Grid container spacing={2}  >
                ...
                <Grid item spacing={2} xs={10} >
                  <Item >
                    ...
                    <Grid>
                      {
                        id % 3 === 0 ?
                          <ButtonGoal variant='contained' onClick={() => handleScheduleClick(id)} >Xếp lịch</ButtonGoal> :

                          (id % 3 === 1 ?
                            <ButtonGoal variant='contained' onClick={() => handleResultClick(id)}>Kết quả</ButtonGoal>
                            : <></>
                          )
                      }
                    </Grid>
                ...
                <InformationContext icon={MuiIcon.Work} title="Vị trí ứng tuyển" context={phone} md={4} />
                <InformationContext icon={StarsIcon} title={'Cấp bậc'} context={website} md={4} />
                <InformationContext icon={MuiIcon.Transgender} title={'Giới tính'} context={'Nam'} md={4} />

                <InformationContext icon={MuiIcon.Phone} title="Số điện thoại" context={phone} md={4} />
                <InformationContext icon={MuiIcon.LocationOn} title="Địa chỉ" context={phone} md={8} />


                <InformationContext icon={MuiIcon.Lightbulb} title="Kĩ năng" context={phone} md={12} />
                <InformationContext icon={MuiIcon.School} title="Học vấn" context={phone} md={12} />
                <InformationContext icon={MuiIcon.EventNote} title="Chứng chỉ" context={phone} md={12} />
                <InformationContext icon={MuiIcon.WorkspacePremium} title="Danh Hiệu và Giải thưởng" context={phone} md={12} />
